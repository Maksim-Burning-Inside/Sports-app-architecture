...
gantt
    ...
    Компонент 2 :active, t2, 2026-06-01, 42d
    Компонент 3 :active, t3, 2026-06-15, 42d

    section Этап 2: Соцсеть
    Компонент 4 : t4, 2026-07-15, 42d
    Компонент 5 : t5, 2026-08-01, 42d
    Компонент 6 : t6, 2026-08-15, 42d

    section Этап 3: ИИ
    Компонент 7 : t7, 2026-09-15, 42d
    Компонент 8 : t8, 2026-10-01, 56d
```
