...
gantt
    ...
    Шлюзы Edge B2C и B2B Partner           :active, p1, 2026-06-01, 4w
    Маркетплейс, профиль инвентаря и износ :active, p2, 2026-06-01, 6w
    Реляционная СУБД и базовый трекинг     :active, p3, 2026-06-15, 6w

    section Этап 2: Социализация и Трафик
    Графовая СУБД и связи пользователей    : p4, 2026-07-15, 6w
    Лента новостей и поиск напарников      : p5, 2026-08-01, 6w
    Шлюз IoT Ingestion и телеметрия датчиков: p6, 2026-08-15, 6w

    section Этап 3: Геймификация и ИИ
    Игровые валюты, награды и испытания    : p7, 2026-09-15, 6w
    ИИ-агент, планы питания и расчет КБЖУ  : p8, 2026-10-01, 8w
```
---
