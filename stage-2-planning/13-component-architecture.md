...
*   **Локальная база данных SQLite (на стороне пользователя).** Отвечает за выполнение сценария Offline-First. В условиях отсутствия сети накапливает данные телеметрии, предотвращая потерю данных.
